function MatrixView() {
	this.matrixModel = new MatrixModel(); // как вариант MatrixModel.call(this); публичный экземпляр
...
MatrixView.prototype.beforeRender = function() {
	this.matrixModel.subscribe('changeData', this.reRender, this); // метод this.reRender тут не вызывается, а только ссылается
}
